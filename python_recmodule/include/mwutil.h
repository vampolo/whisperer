/*
 * @(#)mwutil.h    generated by: makeheader 5.1.5  Wed Feb  2 14:10:12 2011
 *
...
# define utAssert(test)             ((void)0)
# define utAssertStr(test, message) ((void)0)
# define utAssertAlways(message)    ((void)0)
