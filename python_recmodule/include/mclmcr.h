/*
 * @(#)mclmcr.h    generated by: makeheader 5.1.5  Wed Feb  2 14:27:40 2011
 *
 ...
 *				mclStandaloneMain.cpp
 *				mclWaitForFigures.cpp
 *				mclcpp.cpp
 *				mclmccTypes.cpp
 *				mclmcr.cpp
 *				mclmcr_builtin.cpp
...
EXTERN_C size_t getInitOptionsFromCtfStream(const char*** opt, mclCtfStream ctfStream,size_t streamSize);
...
EXTERN_C bool mclInitializeComponentInstanceWithCallbk(HMCRINSTANCE* inst,
                                            mclOutputHandlerFcn error_handler,
                                            mclOutputHandlerFcn print_handler,
...
EXTERN_C bool mclInitializeComponentInstanceFromExtractedComponent( HMCRINSTANCE* inst,
                                                    mclOutputHandlerFcn error_handler,
                                                    mclOutputHandlerFcn print_handler,
                                                    const char* component_id);


EXTERN_C bool mclInitializeComponentInstanceFromExtractedLocation( HMCRINSTANCE* inst,
                                                    mclOutputHandlerFcn error_handler,
                                                    mclOutputHandlerFcn print_handler,
                                                    const char* extractedLoc);


EXTERN_C size_t getInitOptionsFromCtfFile(const char*** opt, const char* full_ctf_filename);
...
EXTERN_C const char * getStandaloneFileName(const char* path_to_ctf, const char* component_name);


EXTERN_C bool mclStandaloneGenericMain( size_t argc, 
                               const char ** argv, 
                               const char* ctfFileName,
                               bool ExtractToComponentCache);


EXTERN_C bool mclStandaloneCtfxMain( size_t argc,
                            const char** argv);
...
EXTERN_C size_t error_info_get_stack_trace(error_info *obj, char*** stack);
...
EXTERN_C bool mclmcrInitialize2(void);
...
EXTERN_C bool allocWcsStackPointer(pwcsStackPointer *ptr, int newLen);
...
EXTERN_C bool mclImpersonationFeval(HMCRINSTANCE inst, const char* name, int nlhs, mxArray** plhs, int nrhs, mxArray** prhs, void* impersonationToken);
...
EXTERN_C  void stopImpersonationOnMCRThread();
